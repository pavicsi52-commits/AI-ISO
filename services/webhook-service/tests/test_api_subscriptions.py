...
class TestListSubscriptions:
    ...
    async def test_list_tenant_isolation(
        ...
        endpoint_id = await _create_endpoint(
            client, auth_headers, organization_id, "isolated-sub-endpoint"
        )
        await client.post(
            "/webhooks/subscriptions",
            params={"organization_id": str(organization_id)},
        ...
        resp = await client.get(
            "/webhooks/subscriptions", params={"organization_id": str(uuid.uuid4())}
        )
        assert resp.json()["data"] == []
...
class TestGetSubscription:
    async def test_get_finds_a_registered_subscription(
        ...
        endpoint_id = await _create_endpoint(
            client, auth_headers, organization_id, "get-sub-endpoint"
        )
    ...
    async def test_get_is_scoped_to_its_organization(
        ...
        endpoint_id = await _create_endpoint(
            client, auth_headers, organization_id, "scoped-sub-endpoint"
        )
        created = await client.post(
            "/webhooks/subscriptions",
            params={"organization_id": str(organization_id)},
...
class TestCreateSubscription:
    async def test_create_requires_auth(
        ...
        endpoint_id = await _create_endpoint(
            client, auth_headers, organization_id, "noauth-sub-endpoint"
        )
        resp = await client.post(
            "/webhooks/subscriptions",
            params={"organization_id": str(organization_id)},
    ...
    async def test_create_returns_the_new_subscription(
        ...
        endpoint_id = await _create_endpoint(
            client, auth_headers, organization_id, "create-sub-endpoint"
        )
        resp = await client.post(
            "/webhooks/subscriptions",
            params={"organization_id": str(organization_id)},
    ...
    async def test_create_records_an_audit_entry(
        ...
        endpoint_id = await _create_endpoint(
            client, auth_headers, organization_id, "audit-sub-endpoint"
        )
        caller = uuid.uuid4()
        resp = await client.post(
            "/webhooks/subscriptions",
...
class TestUpdateSubscription:
    async def test_update_requires_auth(
        ...
        endpoint_id = await _create_endpoint(
            client, auth_headers, organization_id, "update-noauth-sub-endpoint"
        )
        created = await client.post(
            "/webhooks/subscriptions",
            params={"organization_id": str(organization_id)},
    ...
    async def test_update_edits_fields(
        ...
        headers = auth_headers(uuid.uuid4())
        endpoint_id = await _create_endpoint(
            client, auth_headers, organization_id, "edit-sub-endpoint"
        )
        created = await client.post(
            "/webhooks/subscriptions",
            params={"organization_id": str(organization_id)},
    ...
    async def test_update_records_an_audit_entry(
        ...
        headers = auth_headers(uuid.uuid4())
        endpoint_id = await _create_endpoint(
            client, auth_headers, organization_id, "audit-update-sub-endpoint"
        )
        created = await client.post(
            "/webhooks/subscriptions",
            params={"organization_id": str(organization_id)},
...
class TestDeleteSubscription:
    async def test_delete_requires_auth(
        ...
        endpoint_id = await _create_endpoint(
            client, auth_headers, organization_id, "delete-noauth-sub-endpoint"
        )
        created = await client.post(
            "/webhooks/subscriptions",
            params={"organization_id": str(organization_id)},
    ...
    async def test_delete_removes_the_subscription(
        ...
        headers = auth_headers(uuid.uuid4())
        endpoint_id = await _create_endpoint(
            client, auth_headers, organization_id, "delete-sub-endpoint"
        )
        created = await client.post(
            "/webhooks/subscriptions",
            params={"organization_id": str(organization_id)},
    ...
    async def test_delete_records_an_audit_entry(
        ...
        headers = auth_headers(uuid.uuid4())
        endpoint_id = await _create_endpoint(
            client, auth_headers, organization_id, "audit-delete-sub-endpoint"
        )
        created = await client.post(
            "/webhooks/subscriptions",
            params={"organization_id": str(organization_id)},
