...
class TestListFilters:
    async def test_list_is_empty_before_any_registration(
        ...
        subscription_id = await _create_subscription(client, auth_headers, organization_id, "list-filter-endpoint")
    ...
    async def test_list_finds_a_created_filter(
        ...
        subscription_id = await _create_subscription(client, auth_headers, organization_id, "find-filter-endpoint")
        await client.post(
            "/webhooks/filters",
            params={"organization_id": str(organization_id)},
    ...
    async def test_list_needs_no_auth(
        ...
        subscription_id = await _create_subscription(client, auth_headers, organization_id, "noauth-list-filter-endpoint")
        resp = await client.get(
            "/webhooks/filters",
            params={"organization_id": str(organization_id), "subscription_id": subscription_id},
        )
...
class TestCreateFilter:
    async def test_create_needs_no_auth(
        ...
        subscription_id = await _create_subscription(client, auth_headers, organization_id, "noauth-create-filter-endpoint")
    ...
    async def test_create_returns_the_new_filter(
        ...
        subscription_id = await _create_subscription(client, auth_headers, organization_id, "create-filter-endpoint")
...
class TestTenantIsolation:
    ...
    async def test_list_rejects_a_subscription_from_another_organization(
        ...
        subscription_id = await _create_subscription(client, auth_headers, organization_id, "victim-list-endpoint")
    ...
    async def test_create_rejects_a_subscription_from_another_organization(
        ...
        subscription_id = await _create_subscription(client, auth_headers, organization_id, "victim-create-endpoint")
        other_org = uuid.uuid4()
        resp = await client.post(
            "/webhooks/filters",
