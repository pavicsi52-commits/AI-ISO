...
class TestListTransformations:
    async def test_list_is_empty_before_any_registration(
        ...
        endpoint_id = await _create_endpoint(client, auth_headers, organization_id, "list-transform-endpoint")
    ...
    async def test_list_finds_a_created_rule_ordered_by_priority(
        ...
        endpoint_id = await _create_endpoint(client, auth_headers, organization_id, "find-transform-endpoint")
        await client.post(
            "/webhooks/transformations",
            params={"organization_id": str(organization_id)},
            json={
    ...
    async def test_list_needs_no_auth(
        ...
        endpoint_id = await _create_endpoint(client, auth_headers, organization_id, "noauth-list-transform-endpoint")
        resp = await client.get(
            "/webhooks/transformations",
            params={"organization_id": str(organization_id), "endpoint_id": endpoint_id},
        )
...
class TestCreateTransformation:
    async def test_create_needs_no_auth(
        ...
        endpoint_id = await _create_endpoint(client, auth_headers, organization_id, "noauth-create-transform-endpoint")
        resp = await client.post(
            "/webhooks/transformations",
            params={"organization_id": str(organization_id)},
    ...
    async def test_create_returns_the_new_rule(
        ...
        endpoint_id = await _create_endpoint(client, auth_headers, organization_id, "create-transform-endpoint")
        resp = await client.post(
            "/webhooks/transformations",
            params={"organization_id": str(organization_id)},
            json={
...
class TestTenantIsolation:
    ...
    async def test_list_rejects_an_endpoint_from_another_organization(
        ...
        endpoint_id = await _create_endpoint(client, auth_headers, organization_id, "victim-list-endpoint")
    ...
    async def test_create_rejects_an_endpoint_from_another_organization(
        ...
        endpoint_id = await _create_endpoint(client, auth_headers, organization_id, "victim-create-endpoint")
        other_org = uuid.uuid4()
        resp = await client.post(
            "/webhooks/transformations",
