...
router = APIRouter(prefix="/gateway", tags=["Analytics"])
...
async def get_statistics(
    ...
    """The live dashboard snapshot: latest window plus response counts by status code."""
...
async def list_audit(
    ...
    """The append-only gateway audit trail, newest first."""
