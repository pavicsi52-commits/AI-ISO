...
the database this service depends on -- docs/039 names no Neo4j/graph
concept for this service, unlike
``services/asset-management-service``'s own dependency graph.
"""
...
async def health(
    ...
    """Return the overall health of the configuration management service."""
    data = HealthStatus(
        status="healthy",
