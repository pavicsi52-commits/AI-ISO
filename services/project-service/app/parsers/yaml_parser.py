...
No ``shared_core`` wrapper exists for YAML (confirmed by this
service's own reuse research: no YAML library is a dependency anywhere
else in this monorepo) -- ``PyYAML`` is added directly to this
service's own ``pyproject.toml``.
"""
