"""``asset_import_jobs`` table.

Per docs/036 "IMPORT": CSV, Excel, JSON, YAML, ZIP, Bulk Import,
Validation, Preview, Rollback. Reuses
...
this codebase (e.g. ``services/project-service``'s own
``ProjectImportJob``).
"""
...
class AssetImportJob(BaseModel):
    """One bulk asset-import run, from upload through completion."""

    __tablename__ = "asset_import_jobs"
