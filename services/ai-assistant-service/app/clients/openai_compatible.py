...
One implementation serves five of the eight providers docs/046 names --
...
def _parse_tool_calls(raw_calls: list[dict[str, Any]]) -> list[RequestedToolCall]:
    ...
    rather than crashing the whole turn -- the assistant then simply
    answers without that tool, which is far better than failing the
