...
docs/008_Enterprise_Backend_Master_Architecture.md.txt. Unlike the
gateway (which owns no external dependency in its foundation phase),
readiness here genuinely checks the database and cache this service
depends on.
"""
...
async def health(
    ...
    """Return the overall health of the authentication service."""
    data = HealthStatus(
        status="healthy",
