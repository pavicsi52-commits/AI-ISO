"""POST /users/export, GET /users/export/{job_id}."""
...
router = APIRouter(prefix="/users/export", tags=["Export"])
...
async def _to_response(job: UserExportJob, exports: ExportSvc) -> ExportJobResponse:
...
async def start_export(
    ...
    """Queue a bulk user-export job ("Filtered Export")."""
