...
Recomputes every organization's rolling statistics window from the jobs
and executions that already exist. **Leader-elected** through
...
from app.repositories.governance import SchedulerStatisticRepository
...
class StatisticsWorker:
    """Recomputes every organization's scheduler statistics."""
    ...
    async def tick(self) -> int:
        ...
        logger.info(
            "Scheduler statistics rollup complete.",
    ...
    async def _recompute(self, organization_id: UUID) -> bool:
        ...
        try:
            ...
            logger.warning(
                "A scheduler statistics rollup failed; the rest of the tick continues.",
                extra={
