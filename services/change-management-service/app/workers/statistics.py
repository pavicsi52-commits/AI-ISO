...
changes and conflicts that already exist. **Leader-elected** through
...
class StatisticsWorker:
    """Recomputes every organization's change statistics."""
    ...
    async def tick(self) -> int:
        ...
        logger.info(
            "Change statistics rollup complete.",
    ...
    async def _recompute(self, organization_id: UUID) -> bool:
        ...
        try:
            ...
            logger.warning(
                "A change statistics rollup failed; the rest of the tick continues.",
                extra={
